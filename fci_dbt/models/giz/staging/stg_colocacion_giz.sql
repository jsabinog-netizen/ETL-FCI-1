select
    ...
    Adjuntar_certificado_laboral as certificado_laboral,
    ...
    CASE
        WHEN lower(trim(Colocaci_n_Completada)) = 'true' 
            THEN 'Colocado/a'
        WHEN lower(trim(Colocaci_n_Completada)) = 'false' 
            AND Cargo_en_la_empresa IS NOT NULL 
            THEN 'En proceso colocación'
        ELSE 'Pendiente colocación'
    END AS estado_colocacion,
